...
## Purpose
Gerenciar a exibição pública de dados estruturados e analytics do bolão, incluindo a tabela de ranking dos competidores e os dados consolidados ou individuais de palpites por jogo.
