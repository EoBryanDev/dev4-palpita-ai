...
## Purpose
Prover telas e lógicas para que o administrador aprove convites de participação no bolão, controle o status de liberação de palpites e gerencie o cadastro de usuários.
