...
Proteger endpoints de mutação (POST, PUT, DELETE) contra ataques CSRF utilizando tokens de sincronização de formulário. Garante que requisições originadas de outros sites não consigam alterar dados em nome do usuário autenticado.
