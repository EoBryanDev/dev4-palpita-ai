...
Registrar eventos importantes de segurança (login, logout, falhas de autenticação) em formato estruturado para auditoria, debugging e detecção de atividades suspeitas.
