...
- [/] 4.5 Criar uma versão esqueleto da rota pública `/home` (com Banner de Timeout e Toggle de Tema) e da rota `/validation-user/[id]` para validação de tokens. (Status: IN_PROGRESS, Início: 03:33)
