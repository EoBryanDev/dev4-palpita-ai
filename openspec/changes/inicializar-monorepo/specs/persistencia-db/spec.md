...
O sistema DEVE fornecer um banco de dados PostgreSQL configurado em um contêiner Docker para isolar os dados locais de desenvolvimento.
...
O esquema do banco de dados gerido pelo Drizzle ORM DEVE conter as tabelas de usuários, tokens de convite, partidas, rodadas e palpites, utilizando a nomenclatura de Time A e Time B em português.
