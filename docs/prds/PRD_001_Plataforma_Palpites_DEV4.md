...
| #        | Regra                                                                                                                                                                                                                                                                                                               |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **RN01** | **Cálculo de Pontuação:** Se o usuário acertar o placar exato do jogo (resultado final), ganha 1 ponto. Se o usuário errar o placar exato, mas acertar o vencedor ou empate, ganha 1 ponto. Se errar o vencedor e o empate (errar tudo), ganha 0 pontos.                                                            |
